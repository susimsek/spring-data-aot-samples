...
public class AdminNoteController {
  ...
  @Operation(summary = "Create note (admin)", description = "Creates a note.")
  @ApiResponse(
      responseCode = "201",
  ...
  @Operation(summary = "Update note (admin)", description = "Updates title and content of a note.")
  @ApiResponse(
      responseCode = "200",
  ...
  @Operation(summary = "Patch note (admin)", description = "Partially updates a note.")
  @ApiResponse(
      responseCode = "200",
  ...
  @Operation(summary = "Change note owner (admin)", description = "Updates the owner of a note.")
  @ApiResponse(
      responseCode = "200",
  ...
  @ApiResponse(
      ...
      content =
          @Content(
              mediaType = MediaType.APPLICATION_JSON_VALUE,
              schema = @Schema(implementation = ProblemDetail.class)))
  @PostMapping(value = "/{id}/owner", consumes = MediaType.APPLICATION_JSON_VALUE)
  ...
  @Operation(summary = "Delete note (admin)", description = "Deletes a note by id.")
  ...
  @Operation(summary = "Restore note (admin)", description = "Restores a soft-deleted note.")
  ...
  @Operation(summary = "Get note (admin)", description = "Fetches a single note by id.")
  @ApiResponse(
      responseCode = "200",
