...
public record NoteCreateRequest(
        @Schema(description = "Note title", minLength = 3, maxLength = 255, example = "My first note")
        @NotBlank
        @Size(min = 3, max = 255)
        String title,

        @Schema(description = "Note content", minLength = 10, maxLength = 1024, example = "Hello auditing world")
        @NotBlank
