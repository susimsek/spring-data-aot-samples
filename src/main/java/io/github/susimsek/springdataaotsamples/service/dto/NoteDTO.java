...
public record NoteDTO(
        ...
        @Schema(description = "Pinned flag to keep note on top", example = "false")
        boolean pinned,
        ...
        @Schema(description = "Last modified by auditor", example = "bob")
        ...
        @Schema(description = "Deleted by", example = "system")
        String deletedBy,
