...
public record NoteShareDTO(
        @Schema(description = "Identifier of the share token", example = "1")
        Long id,

        @Schema(description = "Raw share token to be used by guests", example = "3b2c...")
        String token,

        @Schema(description = "Note identifier the token is scoped to", example = "42")
        Long noteId,
